...
public class MaximumNumberOfWeeksForWhichYouCanWork{
    public static void main(String[] args){
        ...
        System.out.println(solution.numberOfWeeks(new int[]{1}));
        System.out.println(solution.numberOfWeeks(new int[]{1,2,3}));
        System.out.println(solution.numberOfWeeks(new int[]{5,2,1}));
        System.out.println(solution.numberOfWeeks(new int[]{9,3,6,8,2,1}));
    }
