...
public class CountGoodTriplets{
    public static void main(String[] args){
        ...
        System.out.println(solution.countGoodTriplets(new int[]{7,3,7,3,12,1,12,2,3}, 5, 8, 1));
        System.out.println(solution.countGoodTriplets(new int[]{1,1,2,2,1}, 0, 0, 1));
    }
