...
public class TheEmployeeThatWorkedOnTheLongestTask{
    public static void main(String[] args){
        ...
        //System.out.println(solution.hardestWorker(1, new int[][]{{0, 3}, {2, 5}, {0, 9}, {1, 15}}));
        //System.out.println(solution.hardestWorker(2, new int[][]{{0, 10}, {1, 20}}));
        System.out.println(solution.hardestWorker(2, new int[][]{{36,3},{1,5},{12,8},{25,9},{53,11},{29,12},{52,14}}));
    }
