...
public class DetermineColorOfAChessboardSquare{
    public static void main(String[] args){
        ...
        System.out.println(solution.squareIsWhite("b4"));
        System.out.println(solution.squareIsWhite("b5"));
        System.out.println(solution.squareIsWhite("c5"));
        System.out.println(solution.squareIsWhite("c7"));
        System.out.println(solution.squareIsWhite("c8"));
    }
