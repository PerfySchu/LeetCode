...
public class SimpleBankSystem{
    public static void main(String[] args){
        Bank solution = new SimpleBankSystem().new Bank(new long[]{10, 100, 20, 50, 30});
        System.out.println(solution.withdraw(3, 10));
        System.out.println(solution.transfer(5, 1, 20));
        System.out.println(solution.deposit(5, 20));
        System.out.println(solution.transfer(3, 4, 15));
        System.out.println(solution.withdraw(10, 50));
    }
