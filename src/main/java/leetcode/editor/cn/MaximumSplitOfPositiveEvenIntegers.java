...
public class MaximumSplitOfPositiveEvenIntegers{
    public static void main(String[] args){
        ...
        System.out.println(solution.maximumEvenSplit(12));
        System.out.println(solution.maximumEvenSplit(28));
        System.out.println(solution.maximumEvenSplit(7));
    }
