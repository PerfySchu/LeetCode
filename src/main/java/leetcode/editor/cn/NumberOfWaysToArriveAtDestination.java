...
//
//
// Related Topics 图 拓扑排序 动态规划 最短路 👍 84 👎 0
...
public class NumberOfWaysToArriveAtDestination{
    public static void main(String[] args){
        ...
        System.out.println(solution.countPaths(2, new int[][]{{1, 0, 10}}));
        System.out.println(solution.countPaths(7, new int[][]{{0, 6, 7}, {0, 1, 2}, {1, 2, 3}, {1, 3, 3}, {6, 3, 3}, {3, 5, 1}}));
    }
